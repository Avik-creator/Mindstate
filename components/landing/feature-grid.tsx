    ...
    <section id="memory" className="w-full px-6 py-20 lg:px-12">
      ...
      <Reveal>
        <div className="grid grid-cols-1 border-2 border-foreground md:grid-cols-2">
          <div className="min-h-[280px] border-b-2 border-foreground md:border-b-0 md:border-r-2">
            <TerminalCard />
          </div>
          <div className="min-h-[280px] border-b-2 border-foreground">
            <MemoryCard />
          </div>
          <div className="min-h-[280px] border-t-2 border-foreground md:border-r-2">
            <LimitsCard />
          </div>
          <div className="min-h-[280px] border-t-2 border-foreground">
            <StatusCard />
          </div>
        </div>
      </Reveal>
