...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col bg-background">
      <header className="flex items-center justify-between border-b-2 border-foreground px-5 py-4 sm:px-8">
        <Link href="/" className="flex items-center gap-3 text-sm font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
          <span className="flex size-8 items-center justify-center  bg-primary text-primary-foreground"><Braces aria-hidden="true" /></span>
          Mindstate
        </Link>
      ...
      <section className="flex flex-1 items-center px-5 py-12 sm:px-8 lg:px-16" aria-labelledby="not-found-title">
        <div className="mx-auto grid w-full max-w-6xl items-center gap-12 lg:grid-cols-[1fr_0.9fr] lg:gap-20">
          <div className="max-w-2xl">
            <p className="font-mono text-xs uppercase tracking-widest text-brand">Memory lookup failed</p>
          ...
          <div className="overflow-hidden border-2 border-foreground bg-card shadow-xl" aria-label="Failed memory lookup">
